...
Patch0:        0001-add-elanmoc2-04f3-0ca0.patch
...
* Tue Aug 11 2026 Kate Hsuan <hpa@redhat.com> - 1.94.100-1
- Update to the upstream version 1.94.100 (rhbz#2506519)

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.94.10-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Fri Jun 26 2026 Adam Williamson <awilliam@redhat.com> - 1.94.10-5
- Remove gating.yaml, it's broken

* Fri Jun 26 2026 Kate Hsuan <hpa@redhat.com> - 1.94.10-4
- Add EGIS readers (rhbz#2480599)

* Fri Jun 26 2026 Neal Gompa <ngompa@fedoraproject.org> - 1.94.10-3
- Backport support for new Focal fingerprint reader

* Fri Jun 12 2026 Yaakov Selkowitz <yselkowi@redhat.com> - 1.94.10-2
- Rebuilt for openssl 4.0

* Wed Feb 11 2026 Kate Hsuan <hpa@redhat.com> - 1.94.10-1
- Update to the upstream version 1.94.10 (rhbz#2437070)

* Thu Jan 22 2026 Miroslav Suchý <msuchy@redhat.com> - 1.94.9-7
- migrate license to SPDX

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.94.9-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Mon Dec 15 2025 Neal Gompa <ngompa@fedoraproject.org> - 1.94.9-5
- Drop ExcludeArch for IBM Z to allow building there for COSMIC

* Wed Aug 06 2025 Kate Hsuan <hpa@redhat.com> - 1.94.9-4
- Skip the %%check section due to recent pygobject issues

* Wed Aug 06 2025 Kate Hsuan <hpa@redhat.com> - 1.94.9-3
- Migrate to tmt test

* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.94.9-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Thu Mar 20 2025 Kate Hsuan <hpa@redhat.com> - 1.94.9-1
- Update to the upstream version 1.94.9
- Update to version 1.94.9
- Add openssl-devel dependency
- Add a file /usr/share/metainfo/org.freedesktop.libfprint.metainfo.xml

* Fri Jan 17 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.94.8-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Tue Sep 24 2024 Kate Hsuan <hpa@redhat.com> - 1.94.8-1
- Update to upstream version 1.94.8

* Mon Sep 02 2024 Miroslav Suchý <msuchy@redhat.com> - 1.94.7-3
- convert license to SPDX

* Thu Jul 18 2024 Fedora Release Engineering <releng@fedoraproject.org> - 1.94.7-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Fri Jul 12 2024 Arun Babu Neelicattu <arun.neelicattu@gmail.com> - 1.94.7-1
- Update to 1.94.7

* Fri Jul 12 2024 Arun Babu Neelicattu <arun.neelicattu@gmail.com> - 1.94.6-2
